...
public class SettingsActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email=findViewById(R.id.email_signin_id);
        switchPush=findViewById(R.id.switch_push_notifications);
        profile_btn=findViewById(R.id.btn_profile_id);
        cardView=findViewById(R.id.profile_id_user);
        signin=findViewById(R.id.btn_signin_signout);
        privacy=findViewById(R.id.btn_privacy_id);
        feedback=findViewById(R.id.btn_feedback_id);
        help_btn=findViewById(R.id.btn_help_id);
        speechlyBtn=findViewById(R.id.speechly_btn_settings);

        TextView txt=findViewById(R.id.textSpeechlyId);

        Client speechlyClient= Client.Companion.fromActivity(SettingsActivity.this, UUID.fromString("7183f0cf-c274-44c4-9b2d-c07fe2f1da8c"), StreamConfig.LanguageCode.EN_US,"api.speechly.com",true);
                    ...
                    try {
                        ...
                        if(res!=null) {
                            switch(res.get(0)){
                                case "rating":
                                    if(isLogin()==false){
                                        Toast.makeText(SettingsActivity.this,"You need to login to give feedback",Toast.LENGTH_SHORT).show();
                                    }
                                    else {
                                        if (res.get(1) != null) {
                                            int num = getNumber(res.get(1));
                                            if (num == -1) {
                                                Toast.makeText(SettingsActivity.this, "Not a valid rating. Please go to feedback section for more details...", Toast.LENGTH_SHORT).show();
                                            } else if (num > 0 && num <= 3) {
                                                Toast.makeText(SettingsActivity.this, "You need to provide suggestions in feedback section for such rating.", Toast.LENGTH_SHORT).show();
                                            } else if (num > 3 && num <= 5) {
                                                Toast.makeText(SettingsActivity.this, "You give " + res.get(1) + " rating to this app . Thank for your feedback", Toast.LENGTH_SHORT).show();
                                            }
                                        } else {
                                            Toast.makeText(SettingsActivity.this, "Not a valid rating. Please go to feedback section for more details...", Toast.LENGTH_SHORT).show();
                                        }
                                ...
                                case "logout":
                                    if(isLogin()==false){
                                        Toast.makeText(SettingsActivity.this,"You are already logged out",Toast.LENGTH_SHORT).show();
                                    }
                                    else {
                                        SignOut();
                                    }
                                ...
                                case "login":
                                    if(isLogin()==true){
                                        Toast.makeText(SettingsActivity.this,"You are already logged in.Please log out and again log in then",Toast.LENGTH_SHORT).show();
                                    }
                                    else {
                                        if (res.get(1) != null) {
        ...
        feedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(user != null) {
                    ...
                    Toast.makeText(SettingsActivity.this,"You need to log in to give feedback",Toast.LENGTH_SHORT).show();
                }
        ...
        if(pending!=null){
            pending.addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                ...
                public void onSuccess(AuthResult authResult) {
                    Toast.makeText(SettingsActivity.this, "User already signed in...", Toast.LENGTH_LONG).show();
                }
            });
        }
        else{
            ...
            final EditText edit_text = new EditText(SettingsActivity.this);
            ...
            builder.setPositiveButton("LOG IN", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    p.setScopes(scopes);
                    auth.startActivityForSignInWithProvider(SettingsActivity.this,p.build())
                                    ...
                                    db.collection("User").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                        ...
                                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                            ...
                                            if(ff==false){
                                                ...
                                                Toast.makeText(SettingsActivity.this, "You have successfully logged in", Toast.LENGTH_SHORT).show();
